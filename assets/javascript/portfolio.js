...
$(document).ready(() => {
  const links = [
    ...
    {
      name: 'thanhnam',
      link: 'thanhnammmmmmmm',
    },
    {
      name: 'thuangate',
      link: 'profile.php?id=100007939719785',
    },
  ];
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://www.facebook.com/${link.link}" target="_BLANK">${link.name}</a>`);
  ...
  app.titleChanger(['roses', 'darkred', '666',]);
